...
const AddNewShipingAddress = ({ isModal, toggleModal }) => {
  return (
        ...
        <div className=" bg-black flex flex-col items-center justify-center py-4 pb-8">
          ...
          <div className="bg-black text-white pt-8 pb-8 rounded-lg shadow-lg w-full max-w-lg">
            <form className="space-y-4 pb-6 ">
              <div class="flex divide-x gap-2 divide-gray-800 row">
                {/* <QuestsCategory /> */}
                {/* <QuestsRank /> */}
                {/* <QuestsStyles /> */}
              </div>
              ...
              <div className="flex divide-x  mb-2 divide-gray-800 row">
                <div class="relative flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md w-full max-w-[48rem] flex-row">
                  ...
                  >
                    ...
                    {/* <div className="flex ">
                      {showmenu && (
                        <div className="absolute right-4 pt-4 text-xs  z-20  h-[100px] flex bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 ">
                          <ul>
                  ...
                  <div class=" pt-14 px-6 flex flex-col w-full">
                    <div className="flex justify-between w-full items-center">
                      <h6 class="block font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-gray-700 uppercase">
                        App name
                      </h6>
                    ...
                    <p className="mb-1"></p>
                    <p class=" items-center justify-center gap-4 mb-1 font-sans text-sm font-semibold leading-relaxed text-gray-700">
